...
@Component({
  ...
  imports: [MatIconModule,
    ...
    templateUrl: './AddWbGeneralComponent.component.html',
    styleUrl: './AddWbGeneralComponent.component.scss',
    providers: [
...
export class AddWbGeneralComponent {
          ...
          if(this.workerBonusId){
            ...
            .subscribe((data: CompleteWorkerBonus) => {
              this.bunusForm.patchValue({
                ...
                locationId: data.workerBonus.locationId,
    ...
    returnBack(){
      this.router.navigate(["/worker-bonus-general/" + this.workerId]);
    }
