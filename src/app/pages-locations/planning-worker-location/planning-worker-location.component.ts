...
@Component({
  selector: 'app-planning-worker-location',
  ...
  templateUrl: './planning-worker-location.component.html',
  styleUrl: './planning-worker-location.component.scss'
})
export class PlanningWorkerLocationComponent {
