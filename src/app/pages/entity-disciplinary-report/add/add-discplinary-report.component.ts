...
@Component({
  ...
  templateUrl: './add-discplinary-report.component.html',
  styleUrl: './add-discplinary-report.component.scss',
  providers: [
...
export class AddDiscplinaryReportComponent {
        ...
        this.workerDisciplinaryReportsService.getWorkerDisciplinaryReport(id)
          .subscribe((data: CompleteWorkerDisciplinaryReports) => {
            ...
            this.disciplinaryForm.patchValue({
              ...
              locationId: data.workerDisciplinaryReport.locationId,
              id: id
            });

            this.getWorkersFromLocation(data.workerDisciplinaryReport.locationId, data.worker.id);
  ...
  returnBack(){
    this.router.navigate(["/entity-disciplinary-report"]);
  }
