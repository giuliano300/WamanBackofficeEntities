...
@Component({
  ...
  templateUrl: './worker-planning.component.html',
  styleUrl: './worker-planning.component.scss'
})
export class WorkerPlanningComponent {
  ...
  getWorkerPlanning(workerId:number, year: number){
    this.workerPlanningService.getWorkerPlanning(workerId, year, 0, this.entity!.id)
